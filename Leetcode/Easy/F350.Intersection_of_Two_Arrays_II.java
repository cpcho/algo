...
Follow up:
Q1.What if the given array is already sorted? 
How would you optimize your algorithm?
Q2.What if nums1's size is small compared to nums2's size? 
Which algorithm is better?
Q3.What if elements of nums2 are stored on disk, and 
 the memory is limited such that you cannot load all elements 
 into the memory at once?*/

 /*Answer to Q3 - If only nums2 cannot fit in memory, put all 
 elements of nums1 into a HashMap, read chunks of array that fit 
...
/*The goal of this question is to test whether the interviewee understands 
some of the data engineering techniques. From a data engineer’s perspective,
there are three ideas to solve the question:
...
2.Processing the Strings by chunk, which fits the memory, then deal with each 
