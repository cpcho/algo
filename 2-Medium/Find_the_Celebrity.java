...
/*We can start by finding out a person who is known by most people and then confirm if this person fits all the points noted above. 
O(n) time. We do a pass until 'n', 2 times.*/
...
public int findCelebrity(int n) {
	...
	/*To make sure the value we find out is actually the celebrity, we check if celeb knows none and everyone knows him.*/
	for (int i = 0; i < n; i++) {
